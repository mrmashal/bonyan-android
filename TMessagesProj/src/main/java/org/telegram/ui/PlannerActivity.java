...
public class PlannerActivity extends BaseFragment implements MainTabsActivity.TabFragmentDelegate {
    ...
    public PlannerActivity() { super(); }
    public PlannerActivity(Bundle args) { super(); arguments = args; }
    ...
    private void showTaskOptions(Task task, View anchor) {
        org.telegram.ui.Components.ItemOptions.makeOptions(PlannerActivity.this, anchor)
    ...
    private class CalendarHeaderView extends FrameLayout {
        ...
        CalendarHeaderView(Context context) {
            ...
            selectedDayMs = PlannerActivity.todayMidnight();
            ...
            returnTodayBtn.setOnClickListener(v -> {
                long today = PlannerActivity.todayMidnight();
        ...
        void setSelectedDay(long dayMs, boolean animated) {
            ...
            returnTodayBtn.setVisibility(dayMs == PlannerActivity.todayMidnight() ? GONE : VISIBLE);
    ...
    private abstract static class TaskFormSheet extends android.app.Dialog {
        ...
        protected void onCreate(android.os.Bundle savedInstanceState) {
            ...
            dateBtn = buildChipButton(context, PlannerActivity.formatShortDate(chosenDayMs));
        ...
        private void showDatePicker(Context context) {
            ...
            android.app.DatePickerDialog dpd = new android.app.DatePickerDialog(context,
                    (view, year, month, day) -> {
                        chosenDayMs = PlannerActivity.dayMidnight(year, month, day);
                        dateBtn.setText(PlannerActivity.formatShortDate(chosenDayMs));
                    },
