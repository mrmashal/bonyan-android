...
public class BonyanPersonCell extends FrameLayout {
    ...
    private void updateViews() {
        ...
        avatarImageView.setImage(null, null, Theme.createCircleDrawable(AndroidUtilities.dp(46), Theme.getColor(Theme.key_avatar_backgroundSaved)), null, null, 0, null, null, true);
    }
