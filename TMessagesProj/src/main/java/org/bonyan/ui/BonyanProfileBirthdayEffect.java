...
public class BonyanProfileBirthdayEffect extends View {

    private final int currentAccount;
    private final long dialogId;
    private final BonyanProfileFragment profileActivity;
    ...
    public BonyanProfileBirthdayEffect(BonyanProfileFragment profileActivity, BirthdayEffectFetcher fetcher) {
...
//                    }
    ...
    public static class BirthdayEffectFetcher {
        ...
        public ArrayList<BonyanProfileBirthdayEffect> views = new ArrayList<>();

        public void addView(BonyanProfileBirthdayEffect effect) {
            views.add(effect);
        }

        public void removeView(BonyanProfileBirthdayEffect effect) {
            views.remove(effect);
